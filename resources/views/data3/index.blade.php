        ...
        <div class="panel-body">
          ...
          <table class="table table-hover">
            <tr>
              ...
              @foreach ($mapell as $data)
              <tr>
                <td>{{$data->Kd_Mapel}}</td>
                <td>{{$data->Nama_Mapel}}</td>
                <td>
                  {!! Form::open(array('route'=>['mapel.destroy',$data->id],'method'=>'DELETE')) !!}
                  {{link_to_route('mapel.edit',' Edit',[$data->id],['class'=>'btn btn-primary btn-lg fa fa-wrench'])}}
            ...
            {{link_to_route('mapel.create','Tambah data baru',null,['class'=>'btn btn-success'])}}
