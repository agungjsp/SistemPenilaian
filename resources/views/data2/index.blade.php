          ...
          <table class="table table-hover">
            <tr>
              ...
              <tr>
                ...
                <td>{{$data->ttl}}</td>
                <td>
                  {!! Form::open(array('route'=>['siswa.destroy',$data->id],'method'=>'DELETE')) !!}
                  {{link_to_route('siswa.edit',' Edit',[$data->id],['class'=>'btn btn-primary btn-lg fa fa-wrench'])}}
            ...
            {{link_to_route('siswa.create','Tambah data baru',null,['class'=>'btn btn-success'])}}
